/*
Copyright (c) 2012, Volvo Technology AB
All rights reserved.
Redistribution and use of this material (model, software and documentation), with or without modification, are permitted provided that the following conditions are met:
Redistributions must retain the above copyright notice and this list of conditions. 
The material is intended for research purposes only. Modifications representing refinement and extension are encouraged. Volvo Technology shall have access to such refinements.
*/
