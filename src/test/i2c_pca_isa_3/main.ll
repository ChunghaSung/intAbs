...
@__PRETTY_FUNCTION__.req7 = private unnamed_addr constant [19 x i8] c"void *req7(void *)\00", align 1
@__PRETTY_FUNCTION__.req8 = private unnamed_addr constant [19 x i8] c"void *req8(void *)\00", align 1
...
entry:
  ...
  %0 = load i32, i32* @cnt6, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, i32* @cnt6, align 4
  ret i8* undef
}

; Function Attrs: nounwind uwtable
define i8* @req7(i8* %unused) #0 {
entry:
  store i32 0, i32* @irq, align 4
  store i32 7, i32* @global_id, align 4
  store i32 7, i32* @global_dev, align 4
  %0 = load i32, i32* @global_dev, align 4
  %cmp = icmp ne i32 %0, 7
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 334, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.req7, i32 0, i32 0)) #3
  unreachable
...
; Function Attrs: nounwind uwtable
define i8* @req8(i8* %unused) #0 {
entry:
  store i32 0, i32* @irq, align 4
  store i32 8, i32* @global_id, align 4
  store i32 8, i32* @global_dev, align 4
  %0 = load i32, i32* @global_dev, align 4
  %cmp = icmp ne i32 %0, 8
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 344, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__PRETTY_FUNCTION__.req8, i32 0, i32 0)) #3
  unreachable
...
entry:
  ...
  %call6 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @req7, i8* null) #4
  %call7 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @req8, i8* null) #4
  ret i32 0
}
