...
entry:
  ...
  %2 = load i32, i32* @tickCounter, align 4
  %cmp = icmp ne i32 %2, 0
  br i1 %cmp, label %if.then, label %if.end
...
entry:
  ...
  %call2 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @task_measure2, i8* null) #4
  %call3 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @task_measure3, i8* null) #4
  ret i32 0
}
