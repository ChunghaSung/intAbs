...
@__PRETTY_FUNCTION__.Timer_Reset = private unnamed_addr constant [26 x i8] c"void *Timer_Reset(void *)\00", align 1
...
if.then:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 101, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.Timer_A, i32 0, i32 0)) #3
  unreachable
...
if.then:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.Timer_B, i32 0, i32 0)) #3
  unreachable
...
if.then:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 139, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__PRETTY_FUNCTION__.Timer_C, i32 0, i32 0)) #3
  unreachable
...
; Function Attrs: nounwind uwtable
define i8* @Timer_Reset(i8* %unused) #0 {
entry:
...
if.then:                                          ; preds = %entry
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 166, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__PRETTY_FUNCTION__.Timer_Reset, i32 0, i32 0)) #3
  unreachable
...
entry:
  ...
  %call8 = call i32 @pthread_create(i64* %t5, %union.pthread_attr_t* null, i8* (i8*)* @Timer_Reset, i8* null) #4
  ret i32 0
}
