...
// Lihao
//const int __CPROVER_thread_priorities[] = {5, 2, 8, 55, 142};
const int __CPROVER_thread_priorities[] = {8, 22, 5};
const char* __CPROVER_threads[] = { "c::ir_devnode_ldvwrapper", "c::store_protocols_ldvwrapper", "c::show_protocols_ldvwrapper"};
//const char* __CPROVER_threads[] = { "c::ir_devnode_ldvwrapper", "c::store_protocols_ldvwrapper", "c::show_protocols_ldvwrapper", "c::rc_dev_uevent_ldvwrapper", "c::rc_dev_release_ldvwrapper"};
